...
date: 2025-12-11 10:20:20 +0200
date_updated: 2025-12-11 10:20:20 +0200
permalink: bpl
categories: texte
tags: politique
wide_cover: bpl/rox1_b.png
---
...
{:#autonomie-alimentaire.bpl-secondary-title}
...
{:#retour-note16}
Pour organiser tout ça, le collectif utilise un tableur en ligne, plus précisément un Framacalc, développé et maintenu par Framasoft<a href="#note16" class="bpl-link-to-note">[16]</a>. Celles qui l'ont mis en place sont allées au plus simple : Dans un tableur structuré comme un calendrier, chaque jour dispose de deux cases : une pour le matin, et une pour l'après-midi. Dans chaque case, la personne qui veut utiliser le camion indique son prénom/pseudo et son numéro de portable. Il suffit de regarder si une case est vide pour savoir si le camion est libre.
...
{:#radicalite.bpl-secondary-title}
## 3. Radicalité
...
{:#perspectives.bpl-secondary-title}
## 5. Perspectives
...
En cours de route, j'ai trouvé quel type d'action me convenait. Naturellement, je me retrouve dans la base arrière, pas en première ligne. Il y a beaucoup d'actions d'entraide menées aujourd'hui, et le besoin ne va pas disparaître demain. Même si le reste de ma vie prend trop de place, je pourrais toujours aider dans une cantine.
...
J'ai participé aux actions des Bons petits légumes entre 2022 et 2024, et le collectif a continué d'évoluer depuis. Si vous souhaitez contacter les BPL actuels, vous pouvez utiliser cette adresse : <i>lesbonspetitslegumes@gmail.com</i>
...
<i>Ce qui suit est un rapide résumé de la création des Bons petits légumes. Étant arrivé en 2022, je n'ai pas vécu ces premières années, j'ai donc parlé avec plusieurs membres fondateur.ices pour établir les grandes étapes qui ont menées à la situation actuelle.</i>
...
à Roxana pour le soutien, la relecture, l'illustration de couverture et pour toutes ces fleurs récupérées à Rungis.

<hr class="bpl-thanks-end">

Police de caractère pour le corps du texte : [Luciole](https://luciole-vision.com/fr/index.html)

Police de caractère pour le titre : [Sunlight Dreams](https://www.dafont.com/sunlight-dreams.font)
